...
const ResultPage = () => {
  ...
  const mbtiAxesData = [
    { leftType: 'E', rightType: 'I', leftLabel: '⬅외향형(외부적 충전활력)', rightLabel: '(내부적 충전활력)내향형➡', leftPercentage: percentages['E'] || 50, rightPercentage: percentages['I'] || 50 },
    ...
    { leftType: 'T', rightType: 'F', leftLabel: '⬅사고형(원칙적 결정행동)', rightLabel: '(융통적 결정행동)감정형➡', leftPercentage: percentages['T'] || 50, rightPercentage: percentages['F'] || 50 },
